...
package body Port_Io is
   ...
   -- Uncomment the rest to make the package usable in Linux as root
   -- Note: requires get_iopl_3.o in the build directory
--     procedure Get_IOPL_3;
--     pragma Import(C,Get_IOPL_3,"get_iopl_3");
